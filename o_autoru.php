...
<html lang="hr">
    ...
    <body>
        ...
        <div class="sadrzaj"> 
            ...
            <article style="margin-bottom: 40px;"><h2>O web aplikaciji: </h2><hr>  
            <br>Projektno rješenje prema projektnom zadatku omogućuje korisnicima
             pristup početnoj stranici koja pruža poveznice na stranice za prijavu,
              registraciju, popisa javnih poziva, popisa vrtića, informacija o autoru
               i dokumentaciji. U slučaju da se korisnik prijavi, ovisno o ulogama
                definiranim u projektnom zadatku, korisniku se pruža jedan dodatni
                 link. U slučaju da se prijavi kao administrator, pruža mu se link
                  za administriranjem aplikacijom, u slučaju da se prijavi kao voditelj,
                   omogućuje mu se pristup stranici za moderiranje vrtića.
